    ...
    <body>
        ...
        <?php
         ...
         //search results comes here          
           ...
           $search_query="(select user_id from user_frnds where friend_id=$user_id and response_code=1)
                            union
                          (select user_id from user_acq where acq_id=$user_id and response_code=1)";
                ...
                <table width=80%>
                  ...
                  <img src="includes/getpic.php?photo_id=<?php echo get_profile_pic_id($row[0]) ;?>" width=60px height=60px
                      style="border:2px solid black;padding:0px">
                        ...
                        <td valign="middle">
                             <a href="frnd_confirm.php?frnd_id=<?php echo $row[0];?>">Add connection as friend</a>
                        </td>
                        <td valign="middle">
                             <a href="acq_confirm.php?frnd_id=<?php echo $row[0];?>">Add connection as Acquaintance</a>
                        </td>
                        <td valign="middle">
                             <a href="add_connection_acq.php?frnd_id=<?php echo $row[0];?>">Delete Request</a>
                        </td>
                    </tr>
                </table>
                </center>
