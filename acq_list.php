    ...
    <body>
        ...
        <?php
         ...
         $user_id=$_GET['user_id'];
           ...
           $search_query="select acq_id from user_acq where response_code=2 and
           user_id=$user_id 
           union
           select user_id from user_acq where response_code=2 and
           acq_id=$user_id ";
                ...
                <table width=80%>
                    <tr>
                      ...
                      style="border:2px solid black;padding:0px">
                        ...
                        <td valign="middle">
                             <a href="unacq.php?frnd_id=<?php echo $row[0];?>">Unfriend</a>
                        </td>
                    </tr>
                </table>
                </center>
